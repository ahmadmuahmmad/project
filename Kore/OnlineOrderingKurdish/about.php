...
<div class="heading"style="background-color:darkred;">
   <h3 class="fontchange"> دەربارەی چێشتخانەی هەولێر </h3>
...
<section class="about">
   ...
   <div class="row">
      ...
      <div class="content">
         ...
         <p class="fontchange"> 
      چێشتخانەی هەولێر ئێمە لە ستافێکی پێشکەوتوو پیکهاتەەین کە هەمیشە چێشتخانەکەمان لە خزمەت میوانە بەڕێزەکان دایە بە ئەزمونی چەند ساڵەی کارکردن، باشترین شوێن بۆ ئامادەکردوون
         </p>
         <a href="contact.php" target="_blank" class="btn fontchange">پێشنیار </a>
...
<section class="steps">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3 class="fontchange">  گەیاندنی ٢٤ کاتژمێری</h3>
         <p class="fontchange">  بە زووترین کات خواردنەکەت دەگاتە دەست  </p>
      </div>

      <div class="box">
         <img src="images/step-3.png" alt="">
         <h3 class="fontchange"> چێژێکی تایبەت </h3>
         <p class="fontchange">  تامی خواردنەکانمان تایبەتن  </p>
      </div>
