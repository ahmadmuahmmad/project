   ...
   <div class="swiper hero-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            <div class="content">
               <span class="fontchange" style="color:orange;"> ئێستا بە ئۆنڵاین داوا بکە </span>
               <h3 class="fontchange"> بە تامترین جۆرەکانی خواردن   </h3>
               <a href="menu.php" class="btn fontchange">بینیبی خواردنەکان </a>
            </div>
            <div class="image">
