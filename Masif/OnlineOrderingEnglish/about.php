...
<section class="about">
   <div class="row">
      ...
      <div class="content">
         <h3>why choose us?</h3>
         <p>
         Quality of Service, Food, Ambiance and Value of Money are the primary elements for choosing a restaurant. Masif Resturant is one of the most exquisite fine-dinning restaurant in twin cities with a captivating views, perfect ambiance and scrumptious food. Our team is always looking forward to provide you exceptional services and win your hearts out.
         </p>
...
<section class="steps">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>Enjoy Food</h3>
         <p>The flavors of our food have been forgotten</p>
      </div>
   </div>
</section>
